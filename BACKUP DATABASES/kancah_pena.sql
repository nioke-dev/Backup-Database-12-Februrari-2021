...
--
-- Table structure for table `tb_detail_majalah`
--
...
--
-- Dumping data for table `tb_detail_majalah`
--
...
--
-- Table structure for table `tb_edisi`
--
...
--
-- Dumping data for table `tb_edisi`
--
...
--
-- Table structure for table `tb_img_majalah`
--
...
--
-- Dumping data for table `tb_img_majalah`
--
...
--
-- Indexes for table `tb_detail_majalah`
--
ALTER TABLE `tb_detail_majalah`
  ADD PRIMARY KEY (`id_edisi`);

--
-- Indexes for table `tb_edisi`
--
ALTER TABLE `tb_edisi`
  ADD PRIMARY KEY (`id_edisi`);

--
-- Indexes for table `tb_img_majalah`
--
